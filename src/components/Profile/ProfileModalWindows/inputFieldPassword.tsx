  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        className={`flex h-12 w-60 items-center justify-start rounded-full border bg-transparent p-3 pr-9 outline-none ${error ? 'border-red-600' : 'border-gray-300'} ${isEdit ? 'bg-slate-100' : 'bg-slate-300'}  ${useIsChanged ? 'border-orange-400' : 'border-gray-300'} `}
        onChange={(event) =>
